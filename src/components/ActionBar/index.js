...
const ActionBar = ({ workFlowState, onChangeWorkFlow }) => {
  ...
  const setImportDialogActive = (value) => {
  ...
  const importFlowData = (jsonFlowString) => {
    ...
    <Box className={classes.root}>
      ...
      <Box>
        ...
        <ImportDialog
          ...
          onImport={(jsonData) => importFlowData(jsonData)}
        />
      </Box>
    </Box>
  );
